...
public class BindCDNPurgeEmailAddressesToHeadersMockTest extends BaseOpenStackMockTest<HPCloudObjectStorageApi> {
   ...
   public void testEmailBind() throws Exception {
      ...
      HttpRequest expectedRequest = HttpRequest.builder()
            ...
            .addHeader(HPCloudObjectStorageHeaders.CDN_PURGE_OBJECT_EMAIL, "foo@bar.com, bar@foo.com")
            .build();
