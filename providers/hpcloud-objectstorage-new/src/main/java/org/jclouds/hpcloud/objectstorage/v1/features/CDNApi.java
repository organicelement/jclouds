...
import org.jclouds.hpcloud.objectstorage.v1.reference.HPCloudObjectStorageHeaders;
...
/**
 * Provides access to the CDN API features.
 *
 * <h3>NOTE</h3>
 ...
 * noted in the service catalog for HP Cloud Object Storage during Authentication and set the
 * <code>X-CDN-Enabled</code> header to <code>true</code>.
 *
 * @see {@link org.jclouds.hpcloud.objectstorage.v1.HPCloudObjectStorageApi#getCDNApi(String)}
 */
@Beta
...
public interface CDNApi extends Closeable {
   ...
   @Headers(keys = HPCloudObjectStorageHeaders.CDN_PURGE_OBJECT_EMAIL, values = "{email}")
